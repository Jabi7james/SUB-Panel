...
*   **داشبورد تب‌بندی شده:** تفکیک لیست کاربران، افزودن کاربر جدید و تنظیمات مدیریت.
*   **باکس لینک هوشمند (Smart Link):** تولید خودکار لینک اختصاصی هر کاربر بر اساس دامنه فعلی و قابلیت کپی سریع برای مدیر.
*   **آکاردئون پیشرفته:** نمایش لینک‌های هر کاربر در کشوهای بازشونده با فلش‌های گرافیکی متحرک.
*   **ویرایش کامل:** امکان تغییر نام کاربری و رمز عبور کاربران بدون حذف دیتای قبلی.
