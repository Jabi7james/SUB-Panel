# 🚀 سیستم مدیریت لینک‌های ساب‌اسکریپشن (V2Ray/Xray Subscription Manager)
...
3.  **پوشه اصلی:**
    ...
    *   در **Serv00** یا سی‌پنل وارد پوشه `public_html` شوید.
...
![نمای پنل کاربری](11.png)

![نمای پنل کاربری](12.png)

![نمای پنل کاربری](13.png)

![نمای پنل کاربری](14.png)
